...
test("chessHelper.isMovePossible", (t) => {
  ...
  t.equals(chessHelper.isMovePossible("k", 5, 8, 3, 8, false), true, "black kingside castle")
  t.equals(chessHelper.isMovePossible("k", 5, 8, 7, 8, false), true, "black queenside castle")
  t.equals(chessHelper.isMovePossible("K", 5, 1, 3, 1, false), true, "white kingside castle")
  t.equals(chessHelper.isMovePossible("K", 5, 1, 7, 1, false), true, "white queenside castle")
  t.equals(chessHelper.isMovePossible("k", 5, 8, 7, 7, false), false, "king teleport")
